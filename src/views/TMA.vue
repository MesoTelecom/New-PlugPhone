<template>
  <div class="limiter">
    ...
    <v-card class="filtrorelatorios">
      ...
      <v-select :items="items" label="Fila de Atendimento" v-model="fila" class="filtro"></v-select>
      <v-select :items="items2" label="Informar o Operador" v-model="pin" class="filtro2"></v-select>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Duração Total (Min)", value: "durmin" },
        { text: "TMA (Min)", value: "tmamin" },
        { text: "Máxima Duração (Min)", value: "durmaxmin" },
      ],
      dados: [],
      items: [],
      items2: [],
  ...
  methods: {
    ...
    exibir: async function () {
      ...
      let mediatma = await api.get(
        `/mediatma/${this.fila}/${this.d1}/${this.d2}/${ramalnum}`
      );
      ...
      let totalchamadas = await api.get(
        `/totalchamadastma/${this.fila}/${this.d1}/${this.d2}/${ramalnum}`
      );
      //console.log('totalchamadas:', totalchamadas)
      let realtotalchamadas = totalchamadas.data.dados[0]?.total || 0;
      //console.log('realtotalchamadas: ',realtotalchamadas)
      let totalduracao = await api.get(
        `/totalduracaotma/${this.fila}/${this.d1}/${this.d2}/${ramalnum}`
      );
      ...
      let maximaduracao = await api.get(
        `/maximaduracaotma/${this.fila}/${this.d1}/${this.d2}/${ramalnum}`
      );
      ...
      let fila = this.fila
      tmaminutos = tmaminutos || 0;
      duracaominutos = duracaominutos || 0;
      maximaminutos = maximaminutos || 0;
