  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Duração total (s)", value: "durmin" },
        { text: "TMA (m)", value: "tmamin" },
        { text: "Máxima Duração (s)", value: "durmaxmin" },
      ],
      dados: [],
      items: [],
      items2: [],
  ...
  methods: {
    ...
    listar: async function () {
      ...
      listaTotalAgente.forEach((e) =>{
        ramais = e.extension
        this.items2.push([ramais])
      })
      
      //console.log('Olha aqui',this.items2)
    },
    ...
    saveCSV() {
      ...
      //================================================================
      let csvFile = `"ramal do agente";"chamadas atendidas";"Duração total(m)";"TMA(m)";"Maxima Duração(m)";\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.ramalNum}";"${a.realTotalChamadas}";"${a.durmin}";"${a.tmamin}";"${a.durmaxmin}"\n`;
      });
