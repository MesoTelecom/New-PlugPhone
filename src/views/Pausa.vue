...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Ramal", value: "membername" },
        { text: "Hora da Pausa", value: "datahora" },
        { text: "Hora da Saida da Pausa", value: "despausado" },
        { text: "Duração da Pausa", value: "duracao" },
        { text: "Motivo da Pausa", value: "motivo" },
  ...
  methods: {
    exibir: async function () {
      ...
      let a = await api.get(`/pausa/${this.d1}/${this.d2}`)
      console.log(`/pausa/${this.d1}/${this.d2}`)
      console.log(a.data.dados)
      this.dados = a.data.dados;
    }
  },
  ...
  saveCSV() {
    ...
    //================================================================
    let csvFile = `"Ramal";"data da pausa";"hora da pausa";"hora da saida da pausa";"duração da pausa";\n`;
    this.dados.forEach((a) => {
      csvFile += `"${a.membername}";"${a.datapausa}";"${a.hora}";"${a.despausado}";"${a.duracao}"\n`;
    });
