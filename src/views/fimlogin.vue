...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Telefone", value: "solicitante" },
        { text: "Status De desligamento", value: "razao" },
  ...
  let a = await api.get(`dados/detalhes/${this.d1}/${this.d2}`)
  console.log(`dados/detalhes/${this.d1}/${this.d2}`)   
  console.log(a.data.dados)   
  this.dados = a.data.dados;
