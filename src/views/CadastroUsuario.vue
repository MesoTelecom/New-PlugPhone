    ...
    <v-data-table :headers="headers" :items="desserts" sort-by="calories" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
          ...
          <router-link to="./dashboard" class="linkp">
    ...
    enviarMensagem: async function () {
      ...
      const requestOptions = {
        ...
        headers: {
          ...
          "Authorization": "Bearer EABpILka8Wz0BOz6gcuZCW0PFqZCakFmNbNvi16IZAkQUi94RcEZCnbjptBqGHEPhj5SKYu1DXDbjoQslVkG37oJjtMQbIsZBOd9FtHTvJJC6YfX2LQqSF3ZBMAbKZBIZByUm7FYE9vLyPZCfzXIS7lwouEz4GsnQe5FcxpWEXrZA7oC5ipO8nCelrrNQ3xfXrvyRyg7VPxb80ZChOa8JVMxlZAgZD"
        },
        body: JSON.stringify(
          {
