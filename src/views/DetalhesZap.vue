  ...
  methods: {
    ...
    editItemLogin(item) {
      if (item.plataforma == "Whatsapp") {
        this.$router.push({ name: 'chatrelatorio', params: { processo: item.processo } });
      } else if (item.plataforma == "Telefone") {
    ...
    exibir: async function () {
      ...
      console.log('sou o this', this.dados)
    },


    saveCSV() {

      this.filename = "PlugPhone Detalhes Zap";
      //================================================================
      let csvFile = `"Nome do Agente";"Credor";"Processo";"Estado";"Data Inicio";"Data Fim";"Plataforma"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.usuario}";"${a.credor}";"${a.processo}";"${a.estado}";"${a.dataInicio}";"${a.dataFim}";"${a.plataforma}";\n`;
      });
