...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "nome", value: "calleridname" },
        { text: "chamador", value: "calleridnum" },
        
        { text: "Fila de destino", value: "fila" },
  ...
  this.dados = a.data.dados;
    ...
    saveCSV() {
      ...
      this.filename = "PlugPhone fluxo";
      //================================================================
       let csvFile = `"Uniqueid";"nome";"numero";"fila";"data";\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.uniqueid}";"${a.calleridname}";"${a.calleridnum}";"${a.fila}";"${a.datahora}"\n`;
      });
