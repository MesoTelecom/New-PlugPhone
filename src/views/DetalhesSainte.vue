...
export default {
  ...
  methods: {
    ...
    exibir: async function () {
      let a = await api.get(`/detalhessainte/${this.d1}/${this.d2}`)
    ...
    saveCSV() {
      ...
      //================================================================
      let csvFile = `"N º do agente";"Data e Hora";"Duração";"Duração de espera";"Telefone";"estado"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.solicitante}";"${a.datahora}";"${a.duracao}";"${a.holdtime}";"${a.teleatendente}";"${a.estado}"\n`;
      });
